...
export const api = {
  ...
  createLead: (body: { name: string; phone: string; language_pref?: string; voice_id?: string; agent_name?: string; agent_id?: string; notes?: string; opening_line?: string; campaign?: string }) =>
    asJson<Lead>(
